...
<!-- END THEME STYLES -->
<link rel="shortcut icon" href="favicon-ss.png"/>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
...
<body class="page-header-fixed page-quick-sidebar-over-content page-full-width">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="<?=$baseUrl?>/assets/admin/layout/img/logo.png" alt="logo" class="logo-default"/>
			</a>
			<div class="menu-toggler sidebar-toggler hide">
				<!-- DOC: Remove the above "hide" to enable the sidebar toggler button on header -->
			</div>
		</div>
		<div class="hor-menu hor-menu-light hidden-sm hidden-xs" style="margin: 0 0 0 634px;">
		
			<ul class="nav navbar-nav">
				<!-- DOC: Remove data-hover="dropdown" and data-close-others="true" attributes below to disable the horizontal opening on mouse hover -->
				<li class="classic-menu-dropdown">
					<a href="<?php echo Yii::app()->createAbsoluteUrl('software'); ?>">
					Software Partner <span class="selected">
					</span>
					</a>
				</li>
				
				<li>
					<a href="<?php echo Yii::app()->createAbsoluteUrl('customerlead/create'); ?>">
					+ Add Lead <span class="selected">
					</span>
					</a>
				</li>
				<li>
					<a href="<?php echo Yii::app()->createAbsoluteUrl('customerlead'); ?>">
					Manage Lead<span class="selected">
					</span>
					</a>
				</li>
...
<div class="clearfix">
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse" style="height: 0px;" aria-expanded="false">
			<ul data-auto-scroll="true" data-slide-speed="200" class="page-sidebar-menu">
