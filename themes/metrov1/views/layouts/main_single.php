...
<head>
<meta charset="utf-8"/>
<title>saasworthy.com | donotdo </title>
...
<link href="<?=$baseUrl?>/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
<link href="<?=$baseUrl?>/assets/admin/pages/css/login3.css" rel="stylesheet" type="text/css"/>
...
<link href="<?=$baseUrl?>/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="<?=$baseUrl?>/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
<link rel="shortcut icon" href="favicon-ss_new.svg"/>
